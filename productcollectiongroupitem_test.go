...
func TestProductCollectionGroupItemNew(t *testing.T) {
	...
	_, err := client.ProductCollections.Groups.Items.New(
		context.TODO(),
...
func TestProductCollectionGroupItemUpdate(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestProductCollectionGroupItemDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
