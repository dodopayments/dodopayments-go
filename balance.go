...
const (
	...
	BalanceLedgerEntryEventTypeVisaRdrFee               BalanceLedgerEntryEventType = "visa_rdr_fee"
	BalanceLedgerEntryEventTypeDisputeFeesReversal      BalanceLedgerEntryEventType = "dispute_fees_reversal"
	BalanceLedgerEntryEventTypeDeflectionFees           BalanceLedgerEntryEventType = "deflection_fees"
	BalanceLedgerEntryEventTypeDeflectionFeesReversal   BalanceLedgerEntryEventType = "deflection_fees_reversal"
	BalanceLedgerEntryEventTypeReserveHold              BalanceLedgerEntryEventType = "reserve_hold"
	BalanceLedgerEntryEventTypeReserveRelease           BalanceLedgerEntryEventType = "reserve_release"
	BalanceLedgerEntryEventTypeModerationFees           BalanceLedgerEntryEventType = "moderation_fees"
)

func (r BalanceLedgerEntryEventType) IsKnown() bool {
	switch r {
	case BalanceLedgerEntryEventTypePayment, BalanceLedgerEntryEventTypeRefund, BalanceLedgerEntryEventTypeRefundReversal, BalanceLedgerEntryEventTypeDispute, BalanceLedgerEntryEventTypeDisputeReversal, BalanceLedgerEntryEventTypeTax, BalanceLedgerEntryEventTypeTaxReversal, BalanceLedgerEntryEventTypePaymentFees, BalanceLedgerEntryEventTypeRefundFees, BalanceLedgerEntryEventTypeRefundFeesReversal, BalanceLedgerEntryEventTypeDisputeFees, BalanceLedgerEntryEventTypePayout, BalanceLedgerEntryEventTypePayoutFees, BalanceLedgerEntryEventTypePayoutReversal, BalanceLedgerEntryEventTypePayoutFeesReversal, BalanceLedgerEntryEventTypeDodoCredits, BalanceLedgerEntryEventTypeAdjustment, BalanceLedgerEntryEventTypeCurrencyConversion, BalanceLedgerEntryEventTypeAbandonedCartRecoveryFee, BalanceLedgerEntryEventTypeDunningFees, BalanceLedgerEntryEventTypePaymentRetryFee, BalanceLedgerEntryEventTypeByopFee, BalanceLedgerEntryEventTypeEthocaFees, BalanceLedgerEntryEventTypeEthocaFeesReversal, BalanceLedgerEntryEventTypeVisaRdrFee, BalanceLedgerEntryEventTypeDisputeFeesReversal, BalanceLedgerEntryEventTypeDeflectionFees, BalanceLedgerEntryEventTypeDeflectionFeesReversal, BalanceLedgerEntryEventTypeReserveHold, BalanceLedgerEntryEventTypeReserveRelease, BalanceLedgerEntryEventTypeModerationFees:
		return true
	}
	return false
}
...
const (
	...
	BalanceGetLedgerParamsEventTypeVisaRdrFee               BalanceGetLedgerParamsEventType = "visa_rdr_fee"
	BalanceGetLedgerParamsEventTypeDisputeFeesReversal      BalanceGetLedgerParamsEventType = "dispute_fees_reversal"
	BalanceGetLedgerParamsEventTypeDeflectionFees           BalanceGetLedgerParamsEventType = "deflection_fees"
	BalanceGetLedgerParamsEventTypeDeflectionFeesReversal   BalanceGetLedgerParamsEventType = "deflection_fees_reversal"
	BalanceGetLedgerParamsEventTypeReserveHold              BalanceGetLedgerParamsEventType = "reserve_hold"
	BalanceGetLedgerParamsEventTypeReserveRelease           BalanceGetLedgerParamsEventType = "reserve_release"
	BalanceGetLedgerParamsEventTypeModerationFees           BalanceGetLedgerParamsEventType = "moderation_fees"
)

func (r BalanceGetLedgerParamsEventType) IsKnown() bool {
	switch r {
	case BalanceGetLedgerParamsEventTypePayment, BalanceGetLedgerParamsEventTypeRefund, BalanceGetLedgerParamsEventTypeRefundReversal, BalanceGetLedgerParamsEventTypeDispute, BalanceGetLedgerParamsEventTypeDisputeReversal, BalanceGetLedgerParamsEventTypeTax, BalanceGetLedgerParamsEventTypeTaxReversal, BalanceGetLedgerParamsEventTypePaymentFees, BalanceGetLedgerParamsEventTypeRefundFees, BalanceGetLedgerParamsEventTypeRefundFeesReversal, BalanceGetLedgerParamsEventTypeDisputeFees, BalanceGetLedgerParamsEventTypePayout, BalanceGetLedgerParamsEventTypePayoutFees, BalanceGetLedgerParamsEventTypePayoutReversal, BalanceGetLedgerParamsEventTypePayoutFeesReversal, BalanceGetLedgerParamsEventTypeDodoCredits, BalanceGetLedgerParamsEventTypeAdjustment, BalanceGetLedgerParamsEventTypeCurrencyConversion, BalanceGetLedgerParamsEventTypeAbandonedCartRecoveryFee, BalanceGetLedgerParamsEventTypeDunningFees, BalanceGetLedgerParamsEventTypePaymentRetryFee, BalanceGetLedgerParamsEventTypeByopFee, BalanceGetLedgerParamsEventTypeEthocaFees, BalanceGetLedgerParamsEventTypeEthocaFeesReversal, BalanceGetLedgerParamsEventTypeVisaRdrFee, BalanceGetLedgerParamsEventTypeDisputeFeesReversal, BalanceGetLedgerParamsEventTypeDeflectionFees, BalanceGetLedgerParamsEventTypeDeflectionFeesReversal, BalanceGetLedgerParamsEventTypeReserveHold, BalanceGetLedgerParamsEventTypeReserveRelease, BalanceGetLedgerParamsEventTypeModerationFees:
		return true
	}
	return false
}
