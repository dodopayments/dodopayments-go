...
func TestProductNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Products.New(context.TODO(), dodopayments.ProductNewParams{
		...
		CreditEntitlements: dodopayments.F([]dodopayments.AttachCreditEntitlementParam{{
			...
			ProrationBehavior:            dodopayments.F(dodopayments.CbbProrationBehaviorProrate),
		...
		EntitlementIDs:              dodopayments.F([]string{"string"}),
