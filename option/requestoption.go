...
// RequestOption is an option for the requests made by the Dodo Payments API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/dodopayments/dodopayments-go#readme-requestoptions
...
func WithEnvironmentLiveMode() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://live.dodopayments.com/")
}
...
func WithEnvironmentTestMode() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://test.dodopayments.com/")
}
