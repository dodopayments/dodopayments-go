...
## [1.117.0](https://github.com/dodopayments/dodopayments-go/compare/v1.116.0...v1.117.0) (2026-09-18)


### Features

* **api:** tax id checkout flag, ledger event types, email policy fields ([946909e](https://github.com/dodopayments/dodopayments-go/commit/946909e1634add998b6711453a6235fc1760678b))
* **api:** tax id checkout flag, ledger event types, email policy fields ([0a3beb4](https://github.com/dodopayments/dodopayments-go/commit/0a3beb47e3a5603979f8b3a7e878eb2042a83b29))


### Chores

* add Dependabot config for GitHub Actions ([02aa8dc](https://github.com/dodopayments/dodopayments-go/commit/02aa8dca07099f496fd19067bc5d9586fb423c58))
...
* **api:** register Feature/FeatureType models and expose customer entitlement-grants list endpoint ([b6067e8](https://github.com/dodopayments/dodopayments-go/commit/b6067e8861c232801f89c0497b20cebb7810ffe6))
* **api:** register Feature/FeatureType models and expose customer entitlement-grants list endpoint ([27fae04](https://github.com/dodopayments/dodopayments-go/commit/27fae04ea75f9342ca5278ab64291cd6b4f9a28f))
...
* **api:** regenerate SDK from latest OpenAPI spec ([984ca17](https://github.com/dodopayments/dodopayments-go/commit/984ca17d5abec41a07120ecdd9eaeeb80a73a049))
* **api:** regenerate SDK from latest OpenAPI spec ([7fcc577](https://github.com/dodopayments/dodopayments-go/commit/7fcc5775b806ad2808030c6f08c72e2a8834298f))
...
* **api:** regenerate SDK from latest OpenAPI spec ([215c0ee](https://github.com/dodopayments/dodopayments-go/commit/215c0ee04e4c7d5714acbf01917403db67a304a8))


### Chores

* release 1.99.1 ([d6d66f6](https://github.com/dodopayments/dodopayments-go/commit/d6d66f636466aed3654c88692813aa2c899c5b14))
...
* **api:** fixed a breaking modal change ([578de0e](https://github.com/dodopayments/dodopayments-go/commit/578de0e66e51e5695124578d71d3c88fbe7d8cf6))
...
* **api:** updated openapi spec to v1.99.0 and added missing endpoints as well ([c6dd63c](https://github.com/dodopayments/dodopayments-go/commit/c6dd63cbf0a471c8950b44805bcfc0fa142f9612))
...
* **api:** manual updates ([d7d64cd](https://github.com/dodopayments/dodopayments-go/commit/d7d64cd670e611368887654c4b1ac410f5f0c711))
* **api:** updated openapi spec to 1.98.0 ([3b62b8c](https://github.com/dodopayments/dodopayments-go/commit/3b62b8c6100e3f67d9ce2c8d6300394c43ec9f33))
...
* **internal:** codegen related update ([b37e83c](https://github.com/dodopayments/dodopayments-go/commit/b37e83c5de5a2f2cf817391cb79f291084f1528e))
...
* **api:** update openapi spec to v1.95.3 ([902b5f7](https://github.com/dodopayments/dodopayments-go/commit/902b5f737608ef7b6d77c54ab73f9230d979c126))

## 1.94.0 (2026-04-08)

Full Changelog: [v1.93.0...v1.94.0](https://github.com/dodopayments/dodopayments-go/compare/v1.93.0...v1.94.0)

### Features

* **api:** updated openapi spec to v1.94.2 ([8157766](https://github.com/dodopayments/dodopayments-go/commit/81577662737743dc7e7c2f434a20f71970773c38))
...
* **api:** manual updates ([e8457f4](https://github.com/dodopayments/dodopayments-go/commit/e8457f45742f6d70e7748c609c4b4119b55b5676))
* **api:** updated openapi spec to v1.92.3 ([16cc05d](https://github.com/dodopayments/dodopayments-go/commit/16cc05d5b7edcc8bd281d05f4ae29bf282f719f1))
...
* **internal:** codegen related update ([90c95f5](https://github.com/dodopayments/dodopayments-go/commit/90c95f55844c2f81d65e4af3d6f9a244ec00255b))
* **internal:** minor cleanup ([b59dde1](https://github.com/dodopayments/dodopayments-go/commit/b59dde149662b6e042e13399ddccc59e63feede5))
* **internal:** tweak CI branches ([0f0e330](https://github.com/dodopayments/dodopayments-go/commit/0f0e3301cd590a647aa973e0972291a8282a20c7))
* **internal:** use explicit returns ([65fc75d](https://github.com/dodopayments/dodopayments-go/commit/65fc75dc4de7a0ede17bd230836ed62ab10de839))
* **internal:** use explicit returns in more places ([464cb5c](https://github.com/dodopayments/dodopayments-go/commit/464cb5cde9353c917b8609e494acb8949c0e3bd5))
* **tests:** bump steady to v0.19.4 ([239c321](https://github.com/dodopayments/dodopayments-go/commit/239c321ccf895096691a5a64fd71409fa622e31b))
* **tests:** bump steady to v0.19.5 ([0e4ec1c](https://github.com/dodopayments/dodopayments-go/commit/0e4ec1c7f385c45b46af8081f8fdb0fcc906526a))


### Refactors

* **tests:** switch from prism to steady ([d3fac9d](https://github.com/dodopayments/dodopayments-go/commit/d3fac9da5345e1617ebb7da281e490fa7e3063d8))
...
* **api:** updated openapi spec to v1.87.0 ([4faeba2](https://github.com/dodopayments/dodopayments-go/commit/4faeba261e75d4ca8a36316a8815194fa0be4f2a))
...
* **api:** added more models ([82a6784](https://github.com/dodopayments/dodopayments-go/commit/82a6784048dcb3ab8f2bcc97089965c0c503a1cb))
* **api:** updated to openapi spec v1.86.0 ([bed333b](https://github.com/dodopayments/dodopayments-go/commit/bed333b13ae6dba61cec7c8ddafec0569154e080))
...
* **api:** updated openapi spec to v1.81.0 ([6748fcd](https://github.com/dodopayments/dodopayments-go/commit/6748fcddb517b921d93561ec0b61622f306b827c))


### Chores

* **internal:** codegen related update ([a3e8402](https://github.com/dodopayments/dodopayments-go/commit/a3e84024c8e40e2dea933f2e903b0cd1c29a9305))

## 1.78.0 (2026-02-02)

Full Changelog: [v1.75.1...v1.78.0](https://github.com/dodopayments/dodopayments-go/compare/v1.75.1...v1.78.0)

### Features

* **api:** updated openapi spec for v1.78.1 ([c9d11ad](https://github.com/dodopayments/dodopayments-go/commit/c9d11ada39bf5723303ecd531dca72820606fb04))
...
* **api:** updated openapi spec to v1.75.0 ([0b8b3e9](https://github.com/dodopayments/dodopayments-go/commit/0b8b3e9c2f6f0ca70b97271c1631e12d70b6c9cd))

## 1.74.0 (2026-01-21)

Full Changelog: [v1.73.0...v1.74.0](https://github.com/dodopayments/dodopayments-go/compare/v1.73.0...v1.74.0)

### Features

* **api:** updated openapi spec to v1.74.0 ([f67d7dd](https://github.com/dodopayments/dodopayments-go/commit/f67d7dd98d750e4513beac4909f5b0517c4e37aa))
...
* **api:** manual updates ([c853e71](https://github.com/dodopayments/dodopayments-go/commit/c853e71bd9f3e4933006198c14334c405f0b3414))

## 1.69.0 (2025-12-23)

Full Changelog: [v1.68.0...v1.69.0](https://github.com/dodopayments/dodopayments-go/compare/v1.68.0...v1.69.0)

### Features

* **api:** manual updates ([3596002](https://github.com/dodopayments/dodopayments-go/commit/359600243f2d0f62020dacf86c662e1351aef407))
* **api:** manual updates ([fbd2fa0](https://github.com/dodopayments/dodopayments-go/commit/fbd2fa0bfdd2efff47fc3fec4f49cb97ae637202))
* **api:** manual updates ([704d791](https://github.com/dodopayments/dodopayments-go/commit/704d791904612a3fe0b129d3382dfa7ac630d640))

## 1.68.0 (2025-12-19)

Full Changelog: [v1.67.0...v1.68.0](https://github.com/dodopayments/dodopayments-go/compare/v1.67.0...v1.68.0)

### Features

* **api:** updated openapi spec to v1.68.4 ([8684d29](https://github.com/dodopayments/dodopayments-go/commit/8684d29d7fde35b427ee99c8779f98c34ed37cfd))

## 1.67.0 (2025-12-16)

Full Changelog: [v1.66.2...v1.67.0](https://github.com/dodopayments/dodopayments-go/compare/v1.66.2...v1.67.0)

### Features

* **api:** updated openapi spec to 1.67.0 ([8f7f128](https://github.com/dodopayments/dodopayments-go/commit/8f7f12880d6fc14b93e3e0cfa1ba23439ea4f6ff))

## 1.66.2 (2025-12-12)

Full Changelog: [v1.66.1...v1.66.2](https://github.com/dodopayments/dodopayments-go/compare/v1.66.1...v1.66.2)

### Features

* **api:** manual updates ([6487e42](https://github.com/dodopayments/dodopayments-go/commit/6487e420dacf12360ae6b1f8d5ea6852f2c30ba6))
...
* **api:** updated openapi spec to v1.66.1 ([cbbab55](https://github.com/dodopayments/dodopayments-go/commit/cbbab55cb7f7145461523c86e9941cafab25bd9a))
...
* **api:** updated openapi spec to v1.61.5 ([881523c](https://github.com/dodopayments/dodopayments-go/commit/881523c4d4d0cb8627771967aa7bea4cec94e6a8))

## 1.60.0 (2025-11-14)

Full Changelog: [v1.56.3...v1.60.0](https://github.com/dodopayments/dodopayments-go/compare/v1.56.3...v1.60.0)

### Features

* **api:** added update payment method and updated openapi spec to v1.60.0 ([1f44598](https://github.com/dodopayments/dodopayments-go/commit/1f44598c3b2388553627ab5431477ec430e5f491))

## 1.56.3 (2025-10-29)

Full Changelog: [v1.56.2...v1.56.3](https://github.com/dodopayments/dodopayments-go/compare/v1.56.2...v1.56.3)

### Features

* **api:** updated openapi spec to v1.56.3 ([bc8dbb3](https://github.com/dodopayments/dodopayments-go/commit/bc8dbb3df43c03790813058e22eea68747f6969c))

## 1.56.2 (2025-10-27)

Full Changelog: [v1.56.0...v1.56.2](https://github.com/dodopayments/dodopayments-go/compare/v1.56.0...v1.56.2)

### Features

* **api:** updated to openapi spec v1.56.0 ([ca0416b](https://github.com/dodopayments/dodopayments-go/commit/ca0416b25ff3f72ee22dff87aa3158e1eb8fac70))

## 1.56.0 (2025-10-25)

Full Changelog: [v1.55.7...v1.56.0](https://github.com/dodopayments/dodopayments-go/compare/v1.55.7...v1.56.0)

### Features

* **api:** added unwrap functions for webhooks ([4ac0f36](https://github.com/dodopayments/dodopayments-go/commit/4ac0f36f8b345758728303fc0f37a5512b474aee))

## 1.55.7 (2025-10-17)

Full Changelog: [v1.53.5...v1.55.7](https://github.com/dodopayments/dodopayments-go/compare/v1.53.5...v1.55.7)

### Features

* **api:** updated openapi spec to v1.55.0 ([3e107b3](https://github.com/dodopayments/dodopayments-go/commit/3e107b3d6643da6f73c6b37ef682f75d3deb68f4))
* **api:** updates for openapi spec v1.55.7 ([87308b4](https://github.com/dodopayments/dodopayments-go/commit/87308b489bffc8e88b389946400b58b9d98081f6))
...
* **api:** updated openapi spec to v1.53.2 with customer credits. ([89fc589](https://github.com/dodopayments/dodopayments-go/commit/89fc589773d6a66fae3d8a55f692a6788aae693e))
...
* **api:** updated example ([72473ed](https://github.com/dodopayments/dodopayments-go/commit/72473ed7d4ad1c6639052839c6b3133d923b06d8))
* **api:** updated openapi spec to v1.51.0 and added checkout sessions ([8a1e5e7](https://github.com/dodopayments/dodopayments-go/commit/8a1e5e7b5aef452a49dfc1033d223cb5321ee318))

## 1.49.0 (2025-08-19)

Full Changelog: [v1.48.0...v1.49.0](https://github.com/dodopayments/dodopayments-go/compare/v1.48.0...v1.49.0)

### Features

* **api:** added addons ([093d755](https://github.com/dodopayments/dodopayments-go/commit/093d755aece5219035f418d394fbabdb9299f171))
* **api:** added archive product api ([#31](https://github.com/dodopayments/dodopayments-go/issues/31)) ([b8a1ad3](https://github.com/dodopayments/dodopayments-go/commit/b8a1ad356254b0fd16b4c7e60de7e4e2bbf66310))
* **api:** added brands api in our sdk ([8fd40d9](https://github.com/dodopayments/dodopayments-go/commit/8fd40d97e742829f9dee0c35d4b43f05a87f1821))
* **api:** added change plan api ([b9e8c0f](https://github.com/dodopayments/dodopayments-go/commit/b9e8c0f786769ed95863b48baa498f1ee08e51d8))
* **api:** added discount apis ([#59](https://github.com/dodopayments/dodopayments-go/issues/59)) ([27d2516](https://github.com/dodopayments/dodopayments-go/commit/27d2516073ccc26bfc3c0bb34a86e20cc79bf258))
...
* **api:** added invoice api and update openapi spec ([#19](https://github.com/dodopayments/dodopayments-go/issues/19)) ([c8d46f2](https://github.com/dodopayments/dodopayments-go/commit/c8d46f289cc6ba1e444d3bc90914757e739bade3))
* **api:** api update ([#4](https://github.com/dodopayments/dodopayments-go/issues/4)) ([b8d4404](https://github.com/dodopayments/dodopayments-go/commit/b8d4404cab9b4acbcb3b1b198bf169f91c931ffe))
* **api:** fixed api key schema to bearer ([4b3e2c5](https://github.com/dodopayments/dodopayments-go/commit/4b3e2c59747efba73c3d292fbc4e0e9ec1e07181))
* **api:** fixed license key pagination issues in openapi spec ([4e2425b](https://github.com/dodopayments/dodopayments-go/commit/4e2425b88a5d81541c4e07f1defdc3cb9e156f60))
* **api:** fixed openapi spec ([17e87fd](https://github.com/dodopayments/dodopayments-go/commit/17e87fd0a4a018ec6626375ddb6fe2794bf9e32d))
* **api:** fixed openapi spec issues ([#80](https://github.com/dodopayments/dodopayments-go/issues/80)) ([ed4754d](https://github.com/dodopayments/dodopayments-go/commit/ed4754d4ba5c760e44ee08753649eea10abea3b8))
* **api:** manual updates ([a457694](https://github.com/dodopayments/dodopayments-go/commit/a4576947e57b4f6532fa040ecd96e2c8cc49c00d))
* **api:** manual updates ([47c5394](https://github.com/dodopayments/dodopayments-go/commit/47c5394355c16649552e420a4994d440c1cfb92c))
* **api:** manual updates ([19ed8e6](https://github.com/dodopayments/dodopayments-go/commit/19ed8e6daf0e9f9bde67e6358c5df0a76e49f0db))
* **api:** manual updates ([deb9f20](https://github.com/dodopayments/dodopayments-go/commit/deb9f2069aeedea5f37fbeff60a4b3c3ce316903))
* **api:** manual updates ([2c5bd4f](https://github.com/dodopayments/dodopayments-go/commit/2c5bd4fc350b6c6532f18338570ae11b1ed8bd1a))
* **api:** manual updates ([50c3897](https://github.com/dodopayments/dodopayments-go/commit/50c389793375dc0c54119f65696fc5e5b4582f0a))
* **api:** manual updates ([77fc215](https://github.com/dodopayments/dodopayments-go/commit/77fc2154fdddb56eb5dd103946a0f777f2ba623a))
* **api:** manual updates ([d837d02](https://github.com/dodopayments/dodopayments-go/commit/d837d02482099a3f3d7dece77b19dbc751b9ec67))
* **api:** manual updates ([c6c9a1e](https://github.com/dodopayments/dodopayments-go/commit/c6c9a1e65b7ff42eb7c7c407df1831aef274030f))
* **api:** manual updates ([#103](https://github.com/dodopayments/dodopayments-go/issues/103)) ([832bca1](https://github.com/dodopayments/dodopayments-go/commit/832bca1b797bf3df03d5418afc10d66122aea230))
* **api:** manual updates ([#14](https://github.com/dodopayments/dodopayments-go/issues/14)) ([1cbe057](https://github.com/dodopayments/dodopayments-go/commit/1cbe05778e477aa56568645d96685441b1440039))
* **api:** manual updates ([#35](https://github.com/dodopayments/dodopayments-go/issues/35)) ([98c830c](https://github.com/dodopayments/dodopayments-go/commit/98c830c359c2631b6f0b68b8daefc67202bd0d2c))
* **api:** manual updates ([#36](https://github.com/dodopayments/dodopayments-go/issues/36)) ([50d95bd](https://github.com/dodopayments/dodopayments-go/commit/50d95bdb9f1fa6bd4aff30450b8eb7835f6c390b))
* **api:** manual updates ([#40](https://github.com/dodopayments/dodopayments-go/issues/40)) ([f072e49](https://github.com/dodopayments/dodopayments-go/commit/f072e49a36286aa94e7caa0298a6f5ce976178a0))
* **api:** manual updates ([#53](https://github.com/dodopayments/dodopayments-go/issues/53)) ([ec4d194](https://github.com/dodopayments/dodopayments-go/commit/ec4d194791f2c5324d9137ff0c8acb1d45039426))
* **api:** manual updates ([#68](https://github.com/dodopayments/dodopayments-go/issues/68)) ([9e1694b](https://github.com/dodopayments/dodopayments-go/commit/9e1694b6efa6117e4ce1e969266dcce0de75bf93))
* **api:** manual updates ([#88](https://github.com/dodopayments/dodopayments-go/issues/88)) ([40faf2f](https://github.com/dodopayments/dodopayments-go/commit/40faf2f3bd2d7dfd99d0f4b91d80f5f746e6d92b))
* **api:** manual updates ([#95](https://github.com/dodopayments/dodopayments-go/issues/95)) ([a885738](https://github.com/dodopayments/dodopayments-go/commit/a8857389ac409839ccacc78a7ebad1e878cac946))
* **api:** openapi spec changes ([#58](https://github.com/dodopayments/dodopayments-go/issues/58)) ([a8d4793](https://github.com/dodopayments/dodopayments-go/commit/a8d4793ee2a57617c82b0b9052f9a847c1615fcb))
* **api:** openapi spec updated ([#77](https://github.com/dodopayments/dodopayments-go/issues/77)) ([75eb174](https://github.com/dodopayments/dodopayments-go/commit/75eb1742fb57b9abf08ad8370f975a359cb749f7))
...
* **api:** updated API changes for v0.22.0 ([#49](https://github.com/dodopayments/dodopayments-go/issues/49)) ([d3b999a](https://github.com/dodopayments/dodopayments-go/commit/d3b999aebbb1a062c1f64febb34bff504e99e4e8))
* **api:** updated code for v1.49.0 ([272e1c0](https://github.com/dodopayments/dodopayments-go/commit/272e1c0d25467bd399cf96ca9c30a9e46f520c4c))
* **api:** updated config and updated version to v1.0.0 ([#63](https://github.com/dodopayments/dodopayments-go/issues/63)) ([da24857](https://github.com/dodopayments/dodopayments-go/commit/da24857a1b5091ea8e38b0ee1d6959bb4ef72527))
* **api:** updated open api spec to v1.42.0 ([d2c9973](https://github.com/dodopayments/dodopayments-go/commit/d2c99736491b2d8fee569b97d5b0dde963e3b2c1))
* **api:** updated openapi methods ([#6](https://github.com/dodopayments/dodopayments-go/issues/6)) ([509ecf1](https://github.com/dodopayments/dodopayments-go/commit/509ecf1df441d94731813643c79f0dac5e29e9f4))
* **api:** updated openapi sepc ([#28](https://github.com/dodopayments/dodopayments-go/issues/28)) ([2c0c060](https://github.com/dodopayments/dodopayments-go/commit/2c0c0600f1082c5bb9141b1023457e122cc4acb0))
* **api:** updated openapi spec ([df3395e](https://github.com/dodopayments/dodopayments-go/commit/df3395e217d1f58a08a3696ccd12ca488ea47873))
* **api:** updated openapi spec ([5e34d9b](https://github.com/dodopayments/dodopayments-go/commit/5e34d9bce7ef3715907a22b2854d0cd71d82f3ed))
* **api:** updated openapi spec ([d019788](https://github.com/dodopayments/dodopayments-go/commit/d019788a0e2c0250f6f9a97c460a1b76a923b167))
* **api:** updated openapi spec ([#23](https://github.com/dodopayments/dodopayments-go/issues/23)) ([5cf1c44](https://github.com/dodopayments/dodopayments-go/commit/5cf1c44e0cf618b995297bc02e44d4c70a80824d))
* **api:** updated openapi spec for License Keys ([#11](https://github.com/dodopayments/dodopayments-go/issues/11)) ([f825187](https://github.com/dodopayments/dodopayments-go/commit/f8251877ccf48afe78cc8655d1da2bd032c3515f))
* **api:** updated openapi spec for v1.37.0 ([f9119d9](https://github.com/dodopayments/dodopayments-go/commit/f9119d9303848e072f2c032c31088c63ae90314c))
* **api:** updated openapi spec to 1.27.0 ([a7129ff](https://github.com/dodopayments/dodopayments-go/commit/a7129ffc89fea59b480c22a13c8f93ebc28842b8))
* **api:** updated openapi spec to 1.44.0 ([e4a7915](https://github.com/dodopayments/dodopayments-go/commit/e4a7915bd8b6102804e3fb3763eb8ae5434407f9))
* **api:** updated openapi spec to 1.47.0 ([692e9ce](https://github.com/dodopayments/dodopayments-go/commit/692e9ce2e704820d4b275bf6354d875c0c078576))
* **api:** updated openapi spec to v1.32.0 ([2a91f11](https://github.com/dodopayments/dodopayments-go/commit/2a91f11e58eaf108ce59c0647abf3dfee2d75e50))
* **api:** updated openapi spec to v1.38.0 ([8da4367](https://github.com/dodopayments/dodopayments-go/commit/8da43670e9e0c803408027bdacd93b83f9566ebc))
* **api:** updated openapi spec to v1.40.0 ([0937642](https://github.com/dodopayments/dodopayments-go/commit/0937642c1c49734a8058132c7f3430fde4dcabaf))
* **api:** updated openapi spec to v1.42.5 ([92b9cef](https://github.com/dodopayments/dodopayments-go/commit/92b9cefdd107ba681e33e3b0f67e64e1db213936))
* **api:** updated openapispec to v1.10.1 ([#83](https://github.com/dodopayments/dodopayments-go/issues/83)) ([60e5fbf](https://github.com/dodopayments/dodopayments-go/commit/60e5fbf6906ba46be6d497d4ab0be96930957175))
* **api:** updated readme example ([aac55cf](https://github.com/dodopayments/dodopayments-go/commit/aac55cfaf4eacfcb1f207762eff6b7d65a906013))
* **api:** updated readme example ([a857feb](https://github.com/dodopayments/dodopayments-go/commit/a857feb2f1f08892b0e3d401a435020ab6b8854b))
* **api:** updated stainless config ([#78](https://github.com/dodopayments/dodopayments-go/issues/78)) ([287ad99](https://github.com/dodopayments/dodopayments-go/commit/287ad99c99e093a51e4199a5f064ad6dd275cef1))
* **api:** updated to version 1.34.0 ([6d492b1](https://github.com/dodopayments/dodopayments-go/commit/6d492b166ba75c59a64afc53991b1db967a40fe6))
* **client:** add debug log helper ([d40a334](https://github.com/dodopayments/dodopayments-go/commit/d40a3349fff28e846b268fd9438890ccbe90bed1))
* **client:** add support for endpoint-specific base URLs in python ([29fe06d](https://github.com/dodopayments/dodopayments-go/commit/29fe06d4fb5781ab013fbb7a42d5ff6c27f3779a))
* **client:** add support for reading base URL from environment variable ([bebe577](https://github.com/dodopayments/dodopayments-go/commit/bebe5779bd8a75635b3254e1fd7e2e3815884f16))
* **client:** allow custom baseurls without trailing slash ([#70](https://github.com/dodopayments/dodopayments-go/issues/70)) ([77ce37c](https://github.com/dodopayments/dodopayments-go/commit/77ce37cf301d398c60e90760948cdadc70505403))
* **client:** improve default client options support ([#74](https://github.com/dodopayments/dodopayments-go/issues/74)) ([2138240](https://github.com/dodopayments/dodopayments-go/commit/21382404f884d3b7c2aee89e9eec75f78d44aeba))
* **client:** send `X-Stainless-Timeout` header ([#46](https://github.com/dodopayments/dodopayments-go/issues/46)) ([bb7da3e](https://github.com/dodopayments/dodopayments-go/commit/bb7da3ed9cf101ef18cc91fb40a38ffcecd520f3))
* **client:** support custom http clients ([#101](https://github.com/dodopayments/dodopayments-go/issues/101)) ([d617da4](https://github.com/dodopayments/dodopayments-go/commit/d617da4889bdb246e187038c52af2cc2d9c76181))
* **client:** support optional json html escaping ([3ba8a77](https://github.com/dodopayments/dodopayments-go/commit/3ba8a773627f03ac92efa314ebc47dfcc7b36e5f))


### Bug Fixes

* **client:** clean up reader resources ([73fb3f1](https://github.com/dodopayments/dodopayments-go/commit/73fb3f1d112c7c181178f3496006dd7f178b58f6))
* **client:** correctly update body in WithJSONSet ([1c4550b](https://github.com/dodopayments/dodopayments-go/commit/1c4550b027649d656f35896c2378f9215474cadb))
* **client:** don't truncate manually specified filenames ([#57](https://github.com/dodopayments/dodopayments-go/issues/57)) ([cfde088](https://github.com/dodopayments/dodopayments-go/commit/cfde088614a9bba1cab49788930185e04c7a5487))
* **client:** process custom base url ahead of time ([fb394ff](https://github.com/dodopayments/dodopayments-go/commit/fb394ff29ca5ee6b84e7313059f6ff34534ffcce))
* **client:** return error on bad custom url instead of panic ([#99](https://github.com/dodopayments/dodopayments-go/issues/99)) ([f89f12c](https://github.com/dodopayments/dodopayments-go/commit/f89f12c221accb0a1c70c7a5cd05809a20d0bdbf))
* do not call path.Base on ContentType ([#55](https://github.com/dodopayments/dodopayments-go/issues/55)) ([46275f9](https://github.com/dodopayments/dodopayments-go/commit/46275f99fdb12acf93c87fef40da2d75731de85b))
* don't try to deserialize as json when ResponseBodyInto is []byte ([1f128b1](https://github.com/dodopayments/dodopayments-go/commit/1f128b1e87bb23f65d96a9aaf0e2929a0ec7ac6b))
* fix apijson.Port for embedded structs ([#33](https://github.com/dodopayments/dodopayments-go/issues/33)) ([0cfaa51](https://github.com/dodopayments/dodopayments-go/commit/0cfaa51eaf52d513626fef0e87575417f590f96c))
* fix apijson.Port for embedded structs ([#34](https://github.com/dodopayments/dodopayments-go/issues/34)) ([e6e34a5](https://github.com/dodopayments/dodopayments-go/commit/e6e34a557c9883c72c985a803643e7741e3d1ae2))
* fix early cancel when RequestTimeout is provided for streaming requests ([#51](https://github.com/dodopayments/dodopayments-go/issues/51)) ([3b74daa](https://github.com/dodopayments/dodopayments-go/commit/3b74daa5b6004739ed46d06a22c0c848fc15dffd))
* fix unicode encoding for json ([#42](https://github.com/dodopayments/dodopayments-go/issues/42)) ([30a9148](https://github.com/dodopayments/dodopayments-go/commit/30a9148c58619de43e688795ff4769fb94c1ff94))
* handle empty bodies in WithJSONSet ([b64531d](https://github.com/dodopayments/dodopayments-go/commit/b64531d669147a2348e0d75c8aed869f519d9ef6))
* **pagination:** check if page data is empty in GetNextPage ([45cb300](https://github.com/dodopayments/dodopayments-go/commit/45cb30065c8e0fe92ebdc056cbf2f82c7a6c2bf6))
* **test:** return early after test failure ([#92](https://github.com/dodopayments/dodopayments-go/issues/92)) ([54657bf](https://github.com/dodopayments/dodopayments-go/commit/54657bf4605d4cca984f4d4741ea40c0f67f3cb2))


### Chores

* add request options to client tests ([#90](https://github.com/dodopayments/dodopayments-go/issues/90)) ([aef7f12](https://github.com/dodopayments/dodopayments-go/commit/aef7f129bd041ef4a98043bee3e62032fa38d4dd))
* add UnionUnmarshaler for responses that are interfaces ([#48](https://github.com/dodopayments/dodopayments-go/issues/48)) ([3e27164](https://github.com/dodopayments/dodopayments-go/commit/3e271646490c6b5be180315e49018d32b4c06798))
* **ci:** add timeout thresholds for CI jobs ([a9fcd3a](https://github.com/dodopayments/dodopayments-go/commit/a9fcd3a222b95aec8ef81a4b03c341299421ba51))
* **ci:** enable for pull requests ([76a6efa](https://github.com/dodopayments/dodopayments-go/commit/76a6efa4f48ea67d9b2a3dc7118ea6d2a3c8ca71))
* **ci:** only run for pushes and fork pull requests ([9412686](https://github.com/dodopayments/dodopayments-go/commit/941268665a73e5dcfaf58ab314b54e5f4997aa2a))
* **ci:** only use depot for staging repos ([5023864](https://github.com/dodopayments/dodopayments-go/commit/5023864eb583ff9546350a81fc346a028d7cbc68))
* configure new SDK language ([5838775](https://github.com/dodopayments/dodopayments-go/commit/5838775e08ee84ffd6ee51ff49fb2b41403a48e8))
...
* **docs:** document pre-request options ([e6bc2bb](https://github.com/dodopayments/dodopayments-go/commit/e6bc2bbc410fd872d38883373c5c42d0cf66185d))
* **docs:** grammar improvements ([7bdddc5](https://github.com/dodopayments/dodopayments-go/commit/7bdddc5e42d919dc8dd3955ad853c682213d180c))
* **docs:** improve security documentation ([#86](https://github.com/dodopayments/dodopayments-go/issues/86)) ([6434101](https://github.com/dodopayments/dodopayments-go/commit/643410177754b0038506724bb99e978b8f183558))
* fix typos ([#93](https://github.com/dodopayments/dodopayments-go/issues/93)) ([24e3794](https://github.com/dodopayments/dodopayments-go/commit/24e3794e902ced8f1ce4d5c44bd6553418e6228a))
* go live ([#1](https://github.com/dodopayments/dodopayments-go/issues/1)) ([3f0a126](https://github.com/dodopayments/dodopayments-go/commit/3f0a1260f79359f3d81bc01787b157fefa5401f6))
* improve devcontainer setup ([ab0efc2](https://github.com/dodopayments/dodopayments-go/commit/ab0efc2ccb62eb8f0f9b7f7b3664f943c3e8fb4b))
* **internal:** codegen related update ([09cf967](https://github.com/dodopayments/dodopayments-go/commit/09cf9670902b90e4d5656c862d3cd11c75660c5e))
* **internal:** codegen related update ([03120e4](https://github.com/dodopayments/dodopayments-go/commit/03120e40e20de92e633282e6d18e691b3e252dd2))
* **internal:** codegen related update ([#17](https://github.com/dodopayments/dodopayments-go/issues/17)) ([ed23cf5](https://github.com/dodopayments/dodopayments-go/commit/ed23cf58b49294b0d541652a329a82f9ba972315))
* **internal:** codegen related update ([#21](https://github.com/dodopayments/dodopayments-go/issues/21)) ([a1ab8df](https://github.com/dodopayments/dodopayments-go/commit/a1ab8dfc177785282ad8924f1ce1badb894d2ee4))
* **internal:** codegen related update ([#61](https://github.com/dodopayments/dodopayments-go/issues/61)) ([8787db0](https://github.com/dodopayments/dodopayments-go/commit/8787db0d88bff758825f9cd212c9ed9a4d2453d0))
* **internal:** codegen related update ([#72](https://github.com/dodopayments/dodopayments-go/issues/72)) ([30037ad](https://github.com/dodopayments/dodopayments-go/commit/30037ad1ea3c840fee3b3ae0abd600e685a6c146))
* **internal:** codegen related update ([#8](https://github.com/dodopayments/dodopayments-go/issues/8)) ([e740094](https://github.com/dodopayments/dodopayments-go/commit/e74009426f6606f90863bfaa8e082d65dde1e533))
* **internal:** expand CI branch coverage ([f0fd36c](https://github.com/dodopayments/dodopayments-go/commit/f0fd36c367f7384e09331bf4d10788e615bb77cb))
* **internal:** fix lint script for tests ([f94d2a6](https://github.com/dodopayments/dodopayments-go/commit/f94d2a62b43fa7abd5f8344b2f4e3c1a83d9271e))
* **internal:** reduce CI branch coverage ([3962b87](https://github.com/dodopayments/dodopayments-go/commit/3962b8708a4c12ffcf7ed15fcd611f6beab386e3))
* **internal:** remove extra empty newlines ([#76](https://github.com/dodopayments/dodopayments-go/issues/76)) ([7acf0e0](https://github.com/dodopayments/dodopayments-go/commit/7acf0e0ec637954c0b947a7b4b3b71505190b355))
* **internal:** update comment in script ([c5217c1](https://github.com/dodopayments/dodopayments-go/commit/c5217c1d9fa08988310645b43ec10b2f5579448d))
* lint tests ([5e274f3](https://github.com/dodopayments/dodopayments-go/commit/5e274f34a931312dca5d11ab6f57bc956236035f))
* lint tests in subpackages ([f67936f](https://github.com/dodopayments/dodopayments-go/commit/f67936ffa1c800a60a6d885a66aa85a1f4f1cce0))
* make go mod tidy continue on error ([1830def](https://github.com/dodopayments/dodopayments-go/commit/1830defd71e8a58822ca5a1b71507ff4183b6d7a))
* refactor client tests ([#38](https://github.com/dodopayments/dodopayments-go/issues/38)) ([0cb5d5f](https://github.com/dodopayments/dodopayments-go/commit/0cb5d5f63589bf7d95458178e58ecfa6fefb6a04))
* update @stainless-api/prism-cli to v5.15.0 ([d92cb26](https://github.com/dodopayments/dodopayments-go/commit/d92cb2628c12a7d2d0fde615179bdf3b081a792f))
* use strconv.ParseInt instead of strconv.Atoi for pagination params ([#67](https://github.com/dodopayments/dodopayments-go/issues/67)) ([975409c](https://github.com/dodopayments/dodopayments-go/commit/975409c57f468a44a0a916e721ded6a9b56f19c3))


### Documentation

* document raw responses ([#44](https://github.com/dodopayments/dodopayments-go/issues/44)) ([e0867f7](https://github.com/dodopayments/dodopayments-go/commit/e0867f783275ed13bcfc16faa7ac437c618e1044))
* update documentation links to be more uniform ([8ac3393](https://github.com/dodopayments/dodopayments-go/commit/8ac3393428ec7e4978848188641f492fadd80de3))
* update URLs from stainlessapi.com to stainless.com ([#65](https://github.com/dodopayments/dodopayments-go/issues/65)) ([bd9582e](https://github.com/dodopayments/dodopayments-go/commit/bd9582e436e69fc8b3253bff91bbf35d416dcdfc))
...
* **api:** updated openapi spec to 1.44.0 ([21c42a2](https://github.com/dodopayments/dodopayments-go/commit/21c42a2f35564c8fd46168c16acdc1d66f06bfaf))
...
* **api:** updated open api spec to v1.42.0 ([454e5a0](https://github.com/dodopayments/dodopayments-go/commit/454e5a03741b6d859b3105998cac6237384b6f5a))
...
* lint tests ([ac4e9e6](https://github.com/dodopayments/dodopayments-go/commit/ac4e9e6f28533ac38b5d22b203ee4dcd423754da))

## 1.38.0 (2025-07-05)

Full Changelog: [v1.37.0...v1.38.0](https://github.com/dodopayments/dodopayments-go/compare/v1.37.0...v1.38.0)

### Features

* **api:** updated openapi spec to v1.38.0 ([dcedc65](https://github.com/dodopayments/dodopayments-go/commit/dcedc65bb2746175c0cd0b2497e0d8c08def8abc))
