...
type IntegrationConfigParam struct {
	...
	FeatureType param.Field[IntegrationConfigFeatureType] `json:"feature_type"`
...
type IntegrationConfigFeatureFlagConfigParam struct {
	...
	// Type of capability conferred.
	FeatureType param.Field[IntegrationConfigFeatureFlagConfigFeatureType] `json:"feature_type" api:"required"`
}
...
// Type of capability conferred.
type IntegrationConfigFeatureFlagConfigFeatureType string

const (
	IntegrationConfigFeatureFlagConfigFeatureTypeBoolean IntegrationConfigFeatureFlagConfigFeatureType = "boolean"
)

func (r IntegrationConfigFeatureFlagConfigFeatureType) IsKnown() bool {
	switch r {
	case IntegrationConfigFeatureFlagConfigFeatureTypeBoolean:
		return true
	}
	return false
}
...
func (r IntegrationConfigLicenseKeyConfigFulfillmentMode) IsKnown() bool {
	switch r {
	case IntegrationConfigLicenseKeyConfigFulfillmentModeAuto, IntegrationConfigLicenseKeyConfigFulfillmentModeManual:
		return true
	}
	return false
}
...
// Type of capability conferred.
type IntegrationConfigFeatureType string

const (
	IntegrationConfigFeatureTypeBoolean IntegrationConfigFeatureType = "boolean"
)

func (r IntegrationConfigFeatureType) IsKnown() bool {
	switch r {
	case IntegrationConfigFeatureTypeBoolean:
		return true
	}
	return false
}
...
func (r IntegrationConfigFulfillmentMode) IsKnown() bool {
	switch r {
	case IntegrationConfigFulfillmentModeAuto, IntegrationConfigFulfillmentModeManual:
		return true
	}
	return false
}
...
type IntegrationConfigResponse struct {
	...
	FeatureType IntegrationConfigResponseFeatureType `json:"feature_type"`
	// Figma file identifier to grant access to.
...
type IntegrationConfigResponseFeatureFlagConfig struct {
	...
	// Type of capability conferred. Only `boolean` is supported today.
	FeatureType IntegrationConfigResponseFeatureFlagConfigFeatureType `json:"feature_type" api:"required"`
...
// Type of capability conferred. Only `boolean` is supported today.
type IntegrationConfigResponseFeatureFlagConfigFeatureType string

const (
	IntegrationConfigResponseFeatureFlagConfigFeatureTypeBoolean IntegrationConfigResponseFeatureFlagConfigFeatureType = "boolean"
)

func (r IntegrationConfigResponseFeatureFlagConfigFeatureType) IsKnown() bool {
	switch r {
	case IntegrationConfigResponseFeatureFlagConfigFeatureTypeBoolean:
		return true
	}
	return false
}
...
func (r IntegrationConfigResponseLicenseKeyConfigFulfillmentMode) IsKnown() bool {
	switch r {
	case IntegrationConfigResponseLicenseKeyConfigFulfillmentModeAuto, IntegrationConfigResponseLicenseKeyConfigFulfillmentModeManual:
		return true
	}
	return false
}
...
// Type of capability conferred. Only `boolean` is supported today.
type IntegrationConfigResponseFeatureType string

const (
	IntegrationConfigResponseFeatureTypeBoolean IntegrationConfigResponseFeatureType = "boolean"
)

func (r IntegrationConfigResponseFeatureType) IsKnown() bool {
	switch r {
	case IntegrationConfigResponseFeatureTypeBoolean:
		return true
	}
	return false
}
...
func (r IntegrationConfigResponseFulfillmentMode) IsKnown() bool {
	switch r {
	case IntegrationConfigResponseFulfillmentModeAuto, IntegrationConfigResponseFulfillmentModeManual:
		return true
	}
	return false
}
