...
func (r *ProductCollectionGroupItemService) New(ctx context.Context, id string, groupID string, body ProductCollectionGroupItemNewParams, opts ...option.RequestOption) (res *[]ProductCollectionProduct, err error) {
...
// productCollectionProductJSON contains the JSON metadata for the struct
// [ProductCollectionProduct]
type productCollectionProductJSON struct {
	ID                    apijson.Field
...
func (r productCollectionProductJSON) RawJSON() string {
	return r.raw
}
