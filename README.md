...
The [Dodo Payments](https://dodopayments.com) Go library provides convenient access to [the Dodo Payments REST
...
```sh
go get -u 'github.com/dodopayments/dodopayments-go@v1.13.0'
```
