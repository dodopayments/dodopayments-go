	...
	_, err := client.CheckoutSessions.New(context.TODO(), dodopayments.CheckoutSessionNewParams{
		CheckoutSessionRequest: dodopayments.CheckoutSessionRequestParam{
			...
			FeatureFlags: dodopayments.F(dodopayments.CheckoutSessionFlagsParam{
				...
				AllowCustomerEditingBusinessName: dodopayments.F(true),
				...
				AllowEditingAddons:               dodopayments.F(true),
				...
				RequireCardholderName:            dodopayments.F(true),
				RequirePhoneNumber:               dodopayments.F(true),
				RequireTaxID:                     dodopayments.F(true),
				SinglePage:                       dodopayments.F(true),
			}),
